...
const AdminSamplingManager = () => {
  ...
  const filteredData = samplingData.filter((s) => {
    ...
    const matchesMaterial =
      ...
      (Array.isArray(s.materials)
        ? s.materials.includes(filterMaterial)
        : s.materials === filterMaterial);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: 'Failed to save sampling data. ' + error.message,
        variant: 'destructive',
      });
    } finally {
      setIsSaving(false);
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm animate-in slide-in-from-right-4 duration-300">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <h2 className="text-xl font-bold">
            {isAddingNew ? 'Add New Sampling Record' : 'Edit Sampling Record'}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <ReactSelect
              ...
              onChange={(options) =>
                handleChange('materials', options ? options.map((o) => o.value) : [])
              }
          ...
          <div className="space-y-2">
            <Label>Unit</Label>
            <Select value={editingItem.unit} onValueChange={(value) => handleChange('unit', value)}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <ReactSelect
              ...
              onChange={(options) =>
                handleChange('tcList', options ? options.map((o) => o.value) : [])
              }
              styles={themedReactSelectStyles()}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <ReactSelect
              ...
              onChange={(options) =>
                handleChange('techList', options ? options.map((o) => o.value) : [])
              }
              styles={themedReactSelectStyles()}
            />
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Tooltip>
            ...
            <TooltipContent className="bg-gray-900 text-white border-gray-800">
              <p className="text-xs">Register a new material sampling type</p>
            </TooltipContent>
          </Tooltip>
        </div>
                ...
                >
                  <td className="py-4 px-4 align-top text-gray-600">
                    <div className="flex flex-wrap items-center gap-6 text-sm text-gray-700">
                      ...
                      <p>
                        <span className="font-semibold text-primary">Unit:</span> {item.unit || '-'}
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        {Array.isArray(item.techList) && item.techList.length > 0
                          ? item.techList.join(', ')
                          : '-'}
                      </p>
                      <p>
                  ...
                  <td className="py-4 px-4 text-right align-top">
                    <div className="flex justify-end space-x-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="bg-gray-900 text-white border-gray-800">
                          <p className="text-xs">Permanently delete this sampling record</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  </td>
