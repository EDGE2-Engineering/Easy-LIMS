...
const AdminTestsManager = () => {
    ...
    const filteredTests = tests.filter(t => {
        ...
        const matchesMaterial = filterMaterial === 'all' || (Array.isArray(t.materials) ? t.materials.includes(filterMaterial) : t.materials === filterMaterial);
    ...
    const sortedTests = [...filteredTests].sort((a, b) => {
        ...
        switch (sortField) {
            ...
            case 'hsn':
                ...
                break;
            case 'materials':
                valA = (Array.isArray(a.materials) ? a.materials.join(', ') : (a.materials || '')).toLowerCase();
                valB = (Array.isArray(b.materials) ? b.materials.join(', ') : (b.materials || '')).toLowerCase();
                break;
