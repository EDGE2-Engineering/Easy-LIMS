        ...
        <div className="space-y-8 max-w-6xl mx-auto pb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-500 font-medium mt-1 uppercase text-[10px] tracking-widest ml-1">Track system activity and changes</p>
                </div>
            </div>
                                    ...
                                    <div className="flex-grow space-y-1">
                                        <div className="flex items-center justify-between">
                                            <p className="text-sm font-bold text-gray-900">
                                                ...
                                                <span className="text-primary font-black ml-1.5 tracking-tighter">#{log.jobs?.job_code || 'Unknown'}</span>
                                            </p>
