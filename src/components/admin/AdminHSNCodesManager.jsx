...
import { Plus, Edit, Trash2, Save, Search, AlertCircle, Hash } from 'lucide-react';
  ...
  const handleSave = async () => {
    if (!editingHsnCode.code.trim()) {
      toast({
        ...
        description: 'HSN/SAC code cannot be empty.',
        variant: 'destructive',
      });
      return;
    }
    ...
    try {
      if (isAddingNew) {
        ...
        toast({
          ...
          description: 'New HSN/SAC code has been successfully added.',
        });
      } else {
      ...
      toast({
        title: 'Error',
        description: 'Failed to save HSN/SAC code.',
        variant: 'destructive',
      });
    } finally {
      setIsSaving(false);
    ...
    if (deleteConfirmation.id) {
      try {
        ...
        toast({
          ...
          description: 'The HSN/SAC code has been removed.',
          variant: 'destructive',
        });
      } catch (error) {
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm animate-in slide-in-from-right-4 duration-300">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">
            {isAddingNew ? 'Add New HSN/SAC Code' : 'Edit HSN/SAC Code'}
          </h2>
        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                setEditingHsnCode({ ...editingHsnCode, description: e.target.value })
              }
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-1 uppercase text-[10px] tracking-widest ml-1">
            Manage tax classification codes for GST billing
          </p>
        </div>
      </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-semibold text-gray-900">{deleteConfirmation.code}</span>? This
