...
import { Loader2, Save, RotateCcw, Plus, Trash2, Edit2, ChevronDown, ChevronRight, Share2, GitBranch, AlertTriangle, ArrowRight } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest px-1">States & Transitions</h3>
                                ...
                                <Card key={id} className="border-gray-100 shadow-sm overflow-hidden group hover:border-primary/20 transition-all">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            {expandedStates[id] ? <ChevronDown className="w-4 h-4 text-gray-400" /> : <ChevronRight className="w-4 h-4 text-gray-400" />}
                                            <div>
                                                ...
                                                <div className="space-y-3 pt-2">
                                                    ...
                                                    <div className="space-y-3">
                                                        {config.actions.map((action, idx) => (
                                                            <div key={idx} className="p-3 rounded-xl border border-dashed border-gray-200 space-y-3 bg-gray-50/30">
                                                                        ...
                                                                        <Input
                                                                            ...
                                                                            onChange={(e) => {
                                                                                ...
                                                                                setEditingConfig(prev => {
                                                                                    ...
                                                                                    newActions[idx] = { ...newActions[idx], description: newDesc };
                                                                                    return {
                                                                                        ...prev,
                                                                                        states: {
                                                                                            ...prev.states,
                                                                ...
                                                                <div className="flex items-center justify-between">
                                                                    <div className="flex gap-2">
                                                                        {action.roles.map(role => (
                                                                            <Badge key={role} variant="outline" className="text-[10px] h-4">{role}</Badge>
                                                                        ))}
                                                                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-100 p-4 rounded-xl flex gap-3">
                        ...
                        <p className="text-xs text-amber-800">
                            <strong>Note:</strong> Renaming states or actions only changes their display labels. Internal IDs and logic paths remain intact to ensure system stability.
                        </p>
                    </div>
                </div>
            </div>
