...
import { 
    ...
    CheckCircle2, AlertCircle, Zap, Box, TrendingUp,
    FileCheck, FileClock, ClipboardList, Calendar,
    ArrowRight, ListFilter, UserCheck
} from 'lucide-react';
        ...
        return (
            <div className="h-[70vh] flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm font-bold text-gray-400 uppercase tracking-widest animate-pulse">Loading MRO Dashboard...</p>
                </div>
            </div>
        );
    }
                                ...
                                <div className="divide-y divide-gray-50">
                                    {recentInwards.length === 0 ? (
                                        ...
                                        recentInwards.map((inward) => (
                                            <div key={inward.id} className="p-4 hover:bg-gray-50/50 transition-colors flex justify-between items-center group">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-tight">
                                                            {inward.clients?.client_name} • {new Date(inward.created_at).toLocaleDateString('en-IN')}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-3">
                                                    <Badge variant="outline" className="text-[9px] font-bold uppercase tracking-tight bg-gray-50 text-gray-500 border-gray-100">
                                                        {inward.status}
                                                    </Badge>
                                                    <Button 
                                                        size="icon" 
                                                        ...
                                                        onClick={() => window.location.hash = inward.job_id ? `#/settings/jobs/${inward.job_id}` : '#/settings/system'}
                                                    >
