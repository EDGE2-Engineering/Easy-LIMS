export const MATERIALS = [
  ...
  { id: 'CONCRETE_CORE', name: 'Concrete Core' },
  { id: 'CONCRETE_CUBE', name: 'Concrete Cube' },
  { id: 'SOLID_HOLLOW_CONCRETE_BLOCK', name: 'Solid/Hollow Concrete Block' },
  { id: 'SOIL', name: 'Soil' },
  { id: 'ROCK', name: 'Rock' },
  { id: 'BITUMEN', name: 'Bitumen' },
  { id: 'REINFORCEMENT_STEEL_BARS', name: 'Reinforcement Steel Bars' },
  { id: 'TILES', name: 'Tiles' },
  ...
  { id: 'SDWR', name: 'SDWR' },
  { id: 'ACC_AAC_BLOCKS', name: 'ACC/ AAC Blocks' },
  { id: 'GGBS', name: 'GGBS' },
  { id: 'GSB', name: 'GSB (Granular Sub Base)' },
  { id: 'WMM', name: 'WMM (Wet Mix Maccadam)' },
  { id: 'WBM', name: 'WBM (Wet Bound Maccadam)' },
  { id: 'STRUCTURAL_STEEL', name: 'Structural Steel' },
  { id: 'CONSTRUCTION_WATER', name: 'Construction Water' },
  { id: 'RO_WATER', name: 'RO Water' },
  { id: 'DRINKING_WATER', name: 'Drinking Water' },
  { id: 'FLY_ASH', name: 'Fly Ash' },
  { id: 'SILICA_FUME', name: 'Silica Fume' },
  { id: 'HARDENED_CONCRETE', name: 'Hardened Concrete' },
  { id: 'PAVER_BLOCK', name: 'Paver Block' },
  { id: 'ADMIXTURE', name: 'Admixture' },
];
