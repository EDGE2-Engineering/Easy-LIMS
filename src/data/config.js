...
export const APP_CONFIG = {
    ...
    viewPermissions: {
        ...
        [ROLES.ACCOUNTS.slug]: [VIEWS.DASHBOARD, VIEWS.ACCOUNTS, VIEWS.EXPENSES, VIEWS.WORK_LOG, VIEWS.UTILITIES],
        [ROLES.HUMAN_RESOURCE.slug]: [VIEWS.DASHBOARD, VIEWS.WORK_LOG, VIEWS.APPROVALS]
    }
};
