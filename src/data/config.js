...
export const APP_CONFIG = {
  ...
  viewPermissions: {
    ...
    [ROLES.TECHNICIAN.slug]: [VIEWS.TECHNICIAN_DASHBOARD, VIEWS.JOBS, VIEWS.TESTING, VIEWS.MY_LEAVES],
    ...
    [ROLES.HUMAN_RESOURCE.slug]: [VIEWS.HR_DASHBOARD, VIEWS.WORK_LOG, VIEWS.APPROVALS, VIEWS.MY_LEAVES],
  },
};
