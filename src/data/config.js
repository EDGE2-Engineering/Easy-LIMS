...
export const APP_CONFIG = {
    ...
    viewPermissions: {
        [ROLES.ADMIN]: [VIEWS.DASHBOARD, VIEWS.JOBS, VIEWS.MATERIAL_INWARD, VIEWS.TESTING, VIEWS.ACCOUNTS, VIEWS.EXPENSES, VIEWS.SETTINGS],
        ...
        [ROLES.ACCOUNTS]: [VIEWS.DASHBOARD, VIEWS.JOBS, VIEWS.ACCOUNTS, VIEWS.EXPENSES]
    },
