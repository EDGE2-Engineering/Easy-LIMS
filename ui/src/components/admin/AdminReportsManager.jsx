...
const AdminReportsManager = () => {
  ...
  const fetchReports = async () => {
    setLoading(true);
    try {
      const [usersData, clientsData, reportsData] = await Promise.all([
        apiClient.get('/api/users'),
        apiClient.get('/api/clients'),
        apiClient.get('/api/reports', { params: { order_by: 'created_at', order_dir: 'desc' } }),
      ]);
  ...
  const confirmDelete = async () => {
    try {
      await apiClient.delete(`/api/reports/${deleteConfirmation.reportId}`);
