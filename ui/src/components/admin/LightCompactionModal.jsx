...
/**
 * Modal dialog for Light Compaction Test per IS 2720 (Part 7)
 */
export default function LightCompactionModal({
  isOpen,
  onClose,
  boreholeNo = 'BH-1',
  depth = '',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <DialogTitle className="text-lg font-bold text-gray-900 dark:text-foreground flex items-center gap-2">
                  ...
                  <Badge
                    variant="secondary"
                    className="text-[11px] font-medium bg-amber-50 dark:bg-amber-950/40 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800/40"
                  >
                    IS 2720 Part 7
                  </Badge>
                </DialogTitle>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="hidden text-xs h-8 border-amber-500/30 text-amber-600 dark:text-amber-400 hover:bg-amber-500/5 items-center gap-1.5"
            ...
            <table className="w-full text-xs text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-gray-50/80 dark:bg-muted/40 border-b border-gray-200 dark:border-border text-gray-700 dark:text-gray-300 font-semibold">
                  ...
                  {trials.map((_, i) => (
                    <th key={i} className="p-2 text-center min-w-[90px] bg-amber-50/20 dark:bg-amber-950/10">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-border/60">
                ...
                <tr className="bg-amber-50/20 dark:bg-amber-950/20 font-medium">
                  <td className="p-1.5 text-center text-gray-400 font-mono">R4</td>
                  <td className="p-1.5 text-amber-900 dark:text-amber-300">
                    Bulk Density <span className="text-[10px] text-amber-700/70">[R₃ / Volume]</span>
                  </td>
                  <td className="p-1.5 text-center text-amber-700">g/cc</td>
                  {trials.map((_, i) => (
                    <td key={i} className="p-1.5 text-center font-bold text-amber-700 dark:text-amber-300">
